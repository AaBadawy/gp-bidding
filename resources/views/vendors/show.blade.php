                        ...
                        <div class="flex-grow-1">
                            ...
                            <div class="d-flex justify-content-between flex-wrap mt-1">
                                ...
                                <div class="my-lg-0 my-3">
                                    <a href="#" class="btn btn-sm btn-light-success font-weight-bolder text-uppercase mr-3">Chat with owner</a>
                                    <form action="{{route('dashboard.vendors.activation',['vendor' => $vendor->id])}}" method="POST" class="form-inline">
                                        @csrf
                                        @method('PUT')
                                        <button type="submit" class="btn btn-sm btn-{{$vendor->isActive() ? 'info' : 'success'}} font-weight-bolder text-uppercase m-1">
                                            {{$vendor->isActive() ? 'inactivate': 'activate'}}</button>
                                    </form>
                                </div>
                            </div>
                            <!--end::Title-->
