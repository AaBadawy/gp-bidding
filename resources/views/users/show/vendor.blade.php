                            ...
                            @if($user->vendor?->past_auctions_count)
                                ...
                                <div class="table-responsive">
                                    <table class="table table-borderless table-vertical-center">
                                        ...
                                        <tbody>
                                        @foreach($user->vendor?->past_auctions_count as $auction)
                                            <tr>
                                            <td class="pl-0 py-4">
                                ...
                                <div class="tab-pane fade" id="kt_tab_pane_11_2" role="tabpanel" aria-labelledby="kt_tab_pane_11_1">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-borderless table-vertical-center">
                                            ...
                                            <tbody>
                                            @foreach($user->vendor?->running_auctions_count as $auction)
                                                <tr>
                                                    <td class="pl-0 py-4">
                                                        <div class="symbol symbol-50 symbol-light">
                                                                <span class="symbol-label">
                                ...
                                <div class="tab-pane fade" id="kt_tab_pane_11_3 active" role="tabpanel" aria-labelledby="kt_tab_pane_11_1">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-borderless table-vertical-center">
                                            ...
                                            <tbody>
                                            @foreach($user->vendor?->upcoming_auctions_count as $auction)
                                                <tr>
                                                    <td class="pl-0 py-4">
                                                        <div class="symbol symbol-50 symbol-light">
                                                                <span class="symbol-label">
